...
class AllCancelBooking extends StatefulWidget {
  const AllCancelBooking({super.key});

  @override
  State<AllCancelBooking> createState() => _AllCancelBookingState();
}

class _AllCancelBookingState extends State<AllCancelBooking> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
       appBar: AppBar(
        title: Obx(() {
          return Text('Cancelled Bookings (${_cancelledbookingLengthController.cancelledBookingCollectionLength.toString()})');
        }),
      ),
      body: Row(
        children: [
              ...
              builder:
                ...
                if (snapshot.hasError) {
                  return Container(
                    child: Center(
                      child: Text(
                          'Error occurred while fetching cancelled booking!'),
                    ),
                  );
                }
