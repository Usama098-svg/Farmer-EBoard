...
class AllDeliveredBooking extends StatefulWidget {
  const AllDeliveredBooking({Key? key}) : super(key: key);

  @override
  State<AllDeliveredBooking> createState() => _AllDeliveredBookingState();
}

class _AllDeliveredBookingState extends State<AllDeliveredBooking> {
  final DeliveredBookingLengthController _deliveredbookingLengthController =
      Get.put(DeliveredBookingLengthController());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Obx(() {
          return Text(
              'Delivered Bookings (${_deliveredbookingLengthController.deliveredBookingCollectionLength.value.toString()})');
        }),
      ),
      body: Row(
        children: [
